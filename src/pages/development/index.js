            ...
            <main className="container p-4 mx-auto w-100 md:w-2/3 z-10 relative">
                <div className="flex flex-col lg:flex-row">
                    <div className="lg:w-2/3 w-full lg:order-1 order-2">
                        ...
                        <div className="mb-4">
                            <a className="btn bg-sky-500 text-white font-bold rounded-full bg-gradient-to-r hover:from-pink-500 hover:to-yellow-500" href="https://linkedin.com/in/patarshn" target="_blank">
